...
inline void quot_and_rem(int a, int b, int &q, int &r) { intmath::quot_and_rem(a, b, q, r); }

inline int gcd(int a, int b) { return intmath::gcd(a, b); }

inline int ext_gcd(int a, int b, int &m, int &n) { return intmath::ext_gcd(a, b, m, n); }
