...
vector_over<spffl::polynomials::f2n_poly_t> f2n_poly_list(spffl::polynomials::f2_poly_t m, int deg);
...
vector_over<spffl::intmath::intmod_t> intmod_glist(spffl::intmath::intmod_t g, sp_list_type_t type);
