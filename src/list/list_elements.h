...
tvector<spffl::polynomials::f2n_poly_t> f2npoly_list(spffl::polynomials::f2_poly_t m, int deg);
...
tvector<spffl::polynomials::f2_polymod_t> f2polymod_list(spffl::polynomials::f2_poly_t m, sp_list_type_t);
tvector<spffl::polynomials::f2n_polymod_t> f2npolymod_list(spffl::polynomials::f2n_poly_t m, sp_list_type_t);
tvector<spffl::polynomials::fp_polymod_t> fppolymod_list(spffl::polynomials::fp_poly_t m, sp_list_type_t);

tvector<spffl::intmath::intmod_t> intmod_glist(spffl::intmath::intmod_t g, sp_list_type_t type);
tvector<spffl::polynomials::f2_polymod_t> f2polymod_glist(spffl::polynomials::f2_polymod_t g, sp_list_type_t);
tvector<spffl::polynomials::f2n_polymod_t> f2npolymod_glist(spffl::polynomials::f2n_polymod_t g, sp_list_type_t);
tvector<spffl::polynomials::fp_polymod_t> fppolymod_glist(spffl::polynomials::fp_polymod_t g, sp_list_type_t);
