...
// ----------------------------------------------------------------
int fpnpoly_t::get_char(void) { return this->coeffs[0].get_char(); }
...
// ----------------------------------------------------------------
void fpnpoly_t::quot_and_rem(fpnpoly_t &that, fpnpoly_t &rquot,
                             fpnpoly_t &rrem) {
  fppolymod_t zero = this->coeffs[0] - this->coeffs[0];
...
// ----------------------------------------------------------------
fpnpoly_t gcd(fpnpoly_t a, fpnpoly_t b) { return a.gcd(b); }
...
// ----------------------------------------------------------------
int fpnpoly_t::find_degree(void) const { return this->degree; }
...
// ----------------------------------------------------------------
int fpnpoly_t::operator!=(int v) const { return !(*this == v); }
...
// ----------------------------------------------------------------
std::ostream &operator<<(std::ostream &os, const fpnpoly_t &poly) {
...
std::istream &operator>>(std::istream &is, fpnpoly_t &poly) {
  fppoly_t r;
