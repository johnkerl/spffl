...
public:
  ...
  f2npoly_t(f2polymod_t c3, f2polymod_t c2, f2polymod_t c1, f2polymod_t c0);
  f2npoly_t(f2polymod_t c4, f2polymod_t c3, f2polymod_t c2, f2polymod_t c1,
            f2polymod_t c0);
  f2npoly_t(f2polymod_t c5, f2polymod_t c4, f2polymod_t c3, f2polymod_t c2,
  ...
  friend std::ostream &operator<<(std::ostream &os, const f2npoly_t &poly);
  // Modulus must have already been set:
  friend std::istream &operator>>(std::istream &is, f2npoly_t &poly);
