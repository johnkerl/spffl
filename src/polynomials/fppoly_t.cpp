...
// ----------------------------------------------------------------
fppoly_t::fppoly_t(intmod_t c5, intmod_t c4, intmod_t c3, intmod_t c2,
...
// ----------------------------------------------------------------
int fppoly_t::get_char(void) { return this->coeffs[0].get_modulus(); }
...
// ----------------------------------------------------------------
void fppoly_t::quot_and_rem(fppoly_t &that, fppoly_t &rquot, fppoly_t &rrem) {
  intmod_t zero = this->coeffs[0] - this->coeffs[0];
...
// ----------------------------------------------------------------
fppoly_t gcd(fppoly_t a, fppoly_t b) { return a.gcd(b); }
...
// ----------------------------------------------------------------
int fppoly_t::find_degree(void) const { return this->degree; }
...
// ----------------------------------------------------------------
int fppoly_t::operator!=(int v) const { return !(*this == v); }
...
// ----------------------------------------------------------------
int fppoly_t::operator<(fppoly_t that) const { return this->cmp(CMP_LT, that); }

// ----------------------------------------------------------------
int fppoly_t::operator>(fppoly_t that) const { return this->cmp(CMP_GT, that); }
...
// ----------------------------------------------------------------
std::ostream &operator<<(std::ostream &os, const fppoly_t &poly) {
...
std::istream &operator>>(std::istream &is, fppoly_t &poly) {
  int p = poly.get_char();
  rsstring_t rss;
  char c;
