...
// ----------------------------------------------------------------
int f2npolyrat_t::get_char(void) { return 2; }
...
// ----------------------------------------------------------------
int f2npolyrat_t::operator!=(f2npoly_t that) const { return !(*this == that); }
...
// ----------------------------------------------------------------
f2npoly_t f2npolyrat_t::get_numerator(void) const { return this->numer; }

// ----------------------------------------------------------------
f2npoly_t f2npolyrat_t::get_denominator(void) const { return this->denom; }
