...
// ----------------------------------------------------------------
int f2polyrat_t::get_char(void) { return 2; }
...
// ----------------------------------------------------------------
int f2polyrat_t::operator!=(f2polyrat_t that) const { return !(*this == that); }
...
// ----------------------------------------------------------------
int f2polyrat_t::operator!=(f2poly_t that) const { return !(*this == that); }
...
// ----------------------------------------------------------------
f2poly_t f2polyrat_t::get_numerator(void) const { return this->numer; }

// ----------------------------------------------------------------
f2poly_t f2polyrat_t::get_denominator(void) const { return this->denom; }
