...
// ----------------------------------------------------------------
int fppolyrat_t::get_char(void) { return this->numer.get_char(); }
...
// ----------------------------------------------------------------
int fppolyrat_t::operator!=(fppolyrat_t that) const { return !(*this == that); }
...
// ----------------------------------------------------------------
int fppolyrat_t::operator!=(fppoly_t that) const { return !(*this == that); }
...
// ----------------------------------------------------------------
fppoly_t fppolyrat_t::get_numerator(void) const { return this->numer; }

// ----------------------------------------------------------------
fppoly_t fppolyrat_t::get_denominator(void) const { return this->denom; }
