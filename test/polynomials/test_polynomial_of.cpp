...
// ---------------------------------------------------------------------------
// f2_poly_t (F2[x], bit-packed): concept and basic ops (main-tree API)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// f2_poly_t I/O: from_string (member), operator>> (main-tree API: hex, low bit first)
// ---------------------------------------------------------------------------

TEST_CASE("f2_poly_from_string: hex low-bit-first") {
  using spffl::polynomials::f2_poly_t;

  f2_poly_t p;
  REQUIRE(p.from_string("1"));
