...
// ----------------------------------------------------------------
tmvpoly<f2_polymod_t> get_f(f2_polymod_t &F2_zero, f2_polymod_t &F2_one) {
...
#if 1
  tmvpoly<f2_polymod_t> F2_f =
    tmvpoly<f2_polymod_t>(F2_one, 3, 0, 0) + tmvpoly<f2_polymod_t>(F2_one, 0, 2, 0) +
    tmvpoly<f2_polymod_t>(F2_one, 0, 0, 1) + tmvpoly<f2_polymod_t>(F2_one, 0, 0, 0);
#endif
